...
import { analyzeNeoAnalysis, NeoAnalysisResultCard, calcNeoAnalysisGrade, neoAnalysisGradeColor } from "./NeoAnalysisHelpers.jsx";
  ...
  return(
    <div style={{background:"#fff",minHeight:"100vh",fontFamily:"-apple-system,'Pretendard',sans-serif",color:"#1e293b",fontSize:15,paddingBottom:68}}>
      ...
      <div style={{maxWidth:920,margin:"0 auto",padding:"20px 14px"}}>
        ...
        {page==="track"&&<TrackTab todaySignals={todaySignals} onSave={saveAutoRule}/>}
